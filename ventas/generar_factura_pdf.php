...
$pdf->SetTitle('Factura N° ' . str_pad($venta['id'], 6, '0', STR_PAD_LEFT));
$pdf->SetSubject('Factura de Venta');
$pdf->SetKeywords('Factura, Venta, ' . $empresa['nombre']);
    ...
    <tr>
        <td style="text-align: center;">
            ...
            <div style="border: 2px solid #000; padding: 8px; margin-top: 10px; background-color: #f8f9fa;">
                <h2 style="margin: 0; font-size: 16px; color: #c0392b;">FACTURA</h2>
...
if ($venta['cliente_direccion']) {
    $html .= '<p><strong>Dirección:</strong> ' . $venta['cliente_direccion'] . '</p>';
}
...
$html = '<table border="1" cellpadding="5" cellspacing="0" style="width: 100%; margin-bottom: 15px;">
    <thead>
        <tr style="background-color: #34495e; color: white;">
            ...
            <th style="width: 50%; text-align: left;"><strong>Descripción</strong></th>
            <th style="width: 20%; text-align: right;"><strong>P. Unit.</strong></th>
            <th style="width: 20%; text-align: right;"><strong>Importe</strong></th>
        </tr>
    </thead>
    <tbody>';
...
$html = '<div style="text-align: center; margin-top: 30px; border-top: 1px solid #bdc3c7; padding-top: 15px;">
    <p style="font-size: 14px; color: #27ae60;"><strong>¡Gracias por su preferencia!</strong></p>
    <p style="font-size: 12px; color: #7f8c8d;">Documento tributario válido</p>
